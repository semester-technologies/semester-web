    ...
    <>
        ...
        <div className="custom-container">
          <div className="hero-service-about">
            ...
            <div className="hero-service-about-body">
              <p>Semester Integrated Technologies, your trusted partner in innovative IT solutions. We specialize in delivering cutting-edge services tailored to meet the unique needs of businesses across various industries.</p>
              <ul>
      ...
      <section className="pillars-area">
        <div className="custom-container">
          ...
          <div className="row g-4">
            {[
              { num: '01', title: 'Human-Centric Engineering', desc: "We believe tech should serve people, not just exist." },
              { num: '02', title: 'Radical Transparency', desc: 'Our 6-step workflow and searchable rate cards mean you never have to guess.' },
              { num: '03', title: 'Excellence as a Standard', desc: 'Every project undergoes internal vetting by our senior leads.' },
              { num: '04', title: 'Future-Proofing', desc: 'Our ecosystem constantly updates our stack and syllabus.' },
            ].map(p => (
      ...
      <section className="architecture-area">
        <div className="custom-container">
          ...
          <div className="row g-4">
            {[
              { icon: 'la-graduation-cap', for: 'For Students', title: 'Architecture of Growth', desc: 'A structured path from curiosity to professional mastery.' },
              { icon: 'la-building', for: 'For Clients', title: 'Architecture of Success', desc: 'The technical and legal infrastructure needed to scale.' },
              { icon: 'la-handshake', for: 'For Partners', title: 'Architecture of Impact', desc: 'Strategic collaborations that drive the digital economy forward.' },
            ].map((a, i) => (
        ...
        <div className="custom-container">
          <div className="custom-row align-items-center">
            ...
            <div className="content-box">
              ...
              <p>That's why we don't believe in a one-size-fits-all approach. Instead, our experts work closely with you to understand your specific needs, goals, and pain points.</p>
              <ul>
